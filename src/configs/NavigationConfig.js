...
const managementNavTre = [{
  ...
  submenu: [
    {
      key: 'managements-class',
      path: `${APP_PREFIX_PATH}/managements/class`,
      title: 'sidenav.management.class',
      icon: HomeOutlined,
      breadcrumb: true,
      submenu: [
        {
          key: 'managements-class-list',
          path: `${APP_PREFIX_PATH}/managements/class/class-list`,
          title: 'sidenav.management.class.class-list',
          icon: '',
          breadcrumb: true,
          submenu: []
        },
        {
          key: 'managements-class-add',
          path: `${APP_PREFIX_PATH}/managements/class/add-class`,
          title: 'sidenav.management.class.add-class',
          icon: '',
          breadcrumb: true,
          submenu: []
        },
        {
          key: 'managements-import-class',
          path: `${APP_PREFIX_PATH}/managements/class/import-class`,
          title: 'sidenav.management.class.import-class',
          icon: '',
          breadcrumb: true,
          submenu: []
        },
        {
          key: 'managements-class-recycle',
          path: `${APP_PREFIX_PATH}/managements/class/class-recycle`,
          title: 'sidenav.management.class.class-recycle',
          icon: '',
          breadcrumb: true,
          submenu: []
        },
    ...
    {
      key: 'managements-student',
      path: `${APP_PREFIX_PATH}/managements/student`,
      title: 'sidenav.management.student',
      icon: IdcardOutlined,
      breadcrumb: true,
      submenu: [
        {
          key: 'managements-student-list',
          path: `${APP_PREFIX_PATH}/managements/student/student-list`,
          title: 'sidenav.management.student.student-list',
          icon: '',
          breadcrumb: true,
          submenu: []
        },
        {
          key: 'managements-add-student',
          path: `${APP_PREFIX_PATH}/managements/student/add-student`,
          title: 'sidenav.management.student.add-student',
          icon: '',
          breadcrumb: true,
          submenu: []
        },
        {
          key: 'managements-import-student',
          path: `${APP_PREFIX_PATH}/managements/student/import-student`,
          title: 'sidenav.management.student.import-student',
          icon: '',
          breadcrumb: true,
          submenu: []
        },
        {
          key: 'managements-student-recycle',
          path: `${APP_PREFIX_PATH}/managements/student/student-recycle`,
          title: 'sidenav.management.student.student-recycle',
          icon: '',
          breadcrumb: true,
          submenu: []
        },
    ...
    // {
    //   key: 'managements-demo',
    //   path: `${APP_PREFIX_PATH}/managements/demo`,
    //   title: 'sidenav.demo',
    //   icon: IdcardOutlined,
    //   breadcrumb: true,
    //   submenu: [
    //     {
    //       key: 'managements-demo',
    //       path: `${APP_PREFIX_PATH}/managements/demo/add-demo`,
    //       title: 'sidenav.demo.add-demo',
    //       icon: MailOutlined,
    //       breadcrumb: false,
    //       submenu: []
    //     },
